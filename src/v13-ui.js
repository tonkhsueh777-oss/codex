(function (root) {
  ...
  function renderHandSwapShortcut() {
    ...
    target.innerHTML = `
      ...
      <button type="button" class="action-button action-button--primary hand-side-swap" data-hand-swap aria-label="换一张手牌并结束回合" ${disabled}><span class="action-button__main">换一张手牌</span><span class="action-button__sub">结束回合</span></button>
